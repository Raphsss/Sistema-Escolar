<aside class="fixed left-0 top-0 h-screen w-64 bg-slate-900 border-r border-slate-700">
    ...
    <nav class="p-4 space-y-2">
        ...
        <x-sidebar-link href="#" label="Turmas" :icon="'<path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4\'/>'" />
    </nav>
