...
<div class="p-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400">Preencha os dados para cadastrar um novo aluno</p>
    </div>

    <!-- Formulário -->
    <div class="max-w-2xl">
        <form action="{{ route('alunos.store') }}" method="post" class="bg-slate-900 p-8 rounded-xl space-y-6">
            @csrf
